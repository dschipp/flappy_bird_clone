...
class bird_population():
    def __init__(self, size: int, x_max: int, y_max: int) -> None:
        ...
        self.example_best_bird_save_file_path = path + \
            "/../data/example_best_bird.pickle"

        # Create a Graph to display the NN of the bird that is currently displayed
    ...
    def learn(self, best_birds):
        ...
        logging.debug("Birds are learning from the " +
                      str(len(best_birds)) + " best birds of the population.")
